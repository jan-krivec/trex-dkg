...
class LocalBlockchain {
    async initialize(port, _console = console, version = '') {
        ...
        //     });
        //
        //     // Listen to standard error for error messages
        //     startBlockchainProcess.stderr.on('data', (data) => {
        //         _console.log(`Error: ${data}`);
        //     });
        //
        //     startBlockchainProcess.on('error', (err) => {
        //         _console.log(`Process error: ${err.message}`);
        //     });
        //
        // } catch (e) {
        //     console.log(e);
        ...
        this.provider = new ethers.providers.JsonRpcProvider(`http://hardhat-network:${port}`);
