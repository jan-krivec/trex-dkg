...
interface IModularCompliance {
     ...
     *  `_context` is the address of the token to bind
     */
    event ContextBound(address _context);

    /**
     *  this event is emitted when a token has been unbound from the compliance contract
     *  the event is emitted by the unbindContext function
     *  `_context` is the address of the token to unbind
     */
    event ContextUnbound(address _context);
     ...
     *  @param _context address of the token to bind
     *  This function can be called ONLY by the owner of the compliance contract
     *  Emits a ContextBound event
     */
    function bindContext(address _context) external;

    /**
     *  @dev unbinds a token from the compliance contract
     *  @param _context address of the token to unbind
     *  This function can be called ONLY by the owner of the compliance contract
     *  Emits a ContextUnbound event
     */
    function unbindContext(address _context) external;
    ...
    function addModule(address sender, address _module) external;
    ...
    function callModuleFunction(address sender, bytes calldata callData, address _module) external;
     ...
     */
    function getContextBound() external view returns (address);
