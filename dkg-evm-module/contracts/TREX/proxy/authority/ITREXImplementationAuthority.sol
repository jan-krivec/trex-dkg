...
interface ITREXImplementationAuthority {
    ...
    struct TREXContracts {
        // address of context implementation contract
        address contextImplementation;
    ...
    event ImplementationAuthorityChanged(address indexed _context, address indexed _newImplementationAuthority);
     ...
     *  @param _context the address of the context proxy
     ...
     */
    function changeImplementationAuthority(address _context, address _newImplementationAuthority) external;
    ...
    /**
     *  @dev getter function returning address of context contract implementation
     *  currently used by the proxies using this TREXImplementationAuthority
     */
    function getContextImplementation() external view returns (address);
