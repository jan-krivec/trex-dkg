...
import {DkgIdentity} from "./DkgIdentity.sol";
...
contract Profile is Named, Versioned, ContractStatus, DkgInitializable {
    ...
    DkgIdentity public identityContract;
    ...
    function initialize() public onlyHubOwner {
        ...
        identityContract = DkgIdentity(hub.getContractAddress("DkgIdentity"));
    ...
    function createProfile(
        ...
        DkgIdentity id = identityContract;
