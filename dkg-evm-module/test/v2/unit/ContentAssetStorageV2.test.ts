...
describe('@v2 @unit ContentAssetStorageV2', function () {
  ...
  it('Should increment and return correct context ID on generateTokenId', async function () {
  ...
  it('Should return the correct context URI', async function () {
  ...
  it('Should return correct last context ID', async function () {
    const { tokenId: tokenId1 } = await createAsset();
