...
describe('@v1 @unit ContentAsset contract', function () {
  ...
  it('Create an asset, send 0 context amount, expect to fail', async () => {
  ...
  it('Increase asset context amount, expect context amount to be updated', async () => {
    const tokenId = await createAsset();
  ...
  it('Increase asset context amount using non-owner account, expect to be reverted', async () => {
    const tokenId = await createAsset();
    const additionalTokenAmount = hre.ethers.utils.parseEther('10');
  ...
  it('Increase asset update context amount, expect update context amount to be updated', async () => {
    const tokenId = await createAsset();
    await updateAsset(tokenId);
  ...
  it('Increase asset update context amount using non-owner account, expect to be reverted', async () => {
    const tokenId = await createAsset();
    await updateAsset(tokenId);
    const additionalUpdateTokenAmount = hre.ethers.utils.parseEther('10');
  ...
  it('Increase asset update context amount without pending update, expect to be reverted', async () => {
    const tokenId = await createAsset();
    const additionalUpdateTokenAmount = hre.ethers.utils.parseEther('10');
